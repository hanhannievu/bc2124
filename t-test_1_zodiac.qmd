...
To see exactly how these constructs were measured and how the data is coded you will look up the variable IDs (the `big5xx` and `zodiac` codes in parentheses above) in the [GSS data explorer](https://gssdataexplorer.norc.org/variables/vfilter).

## Step 2. Read relevant research {#sec-astrology-references}
...
Smithers, A. G., & Cooper, H. J. (1978). [Personality and season of birth](https://www.proquest.com/docview/1290725896). *The Journal of Social Psychology, 105*(2), 237-241. [https://doi.org/10.1080/00224545.1978.9924120](https://www.proquest.com/docview/1290725896)
:::
...
If you do expect a difference, you should also specify which group you expect to score higher/lower, and how substantial you expect it to be (i.e. a weak, moderate, or strong effect size; see [Appendix](appendix-t-test.html#sec-t-effect-size)).

## To do for next time

Read up on the development of the TIPI ([Gosling et al., 2003](https://gosling.psy.utexas.edu/wp-content/uploads/2014/09/JRP-03-tipi.pdf)). The more detailed your understanding of how the Big Five trait was measured, the better you will be able to interpret the results of your analysis.
